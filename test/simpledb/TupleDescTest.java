...
public class TupleDescTest extends SimpleDbTestBase {
    ...
    @Test public void testEquals() {
        ...
        TupleDesc intStringName = new TupleDesc(new Type[]{Type.INT_TYPE, Type.STRING_TYPE},
                new String[]{"A", "B"});
        assertTrue(intString.equals(intStringName));
        assertTrue(intStringName.equals(intString));
    }
