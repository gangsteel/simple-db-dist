...
/**
 * Created by aditisri on 12/5/17.
 */
public class AggregateTest {
    private static final Logger LOGGER = Logger.getLogger(AggregateTest.class.getName());
...
//        }
        ...
        QueryTree agg1 = QueryTree.aggregate(QueryTree.scan(null, tableName1, tableName1), 0, Aggregator.Op.AVG);
        LOGGER.log(Level.INFO, "Performing scan of table1");
        headNode.processQuery(agg1);
